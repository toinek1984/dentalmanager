# apps/klanten/urls.py
from django.urls import path
from . import views

urlpatterns = [
    # Overzicht van alle klanten
    path('klantenoverzicht/', views.klantenoverzicht),
    # Formulier voor nieuwe klant
    path('klantaanmaken/',    views.klantaanmaken),
    # JSON‑endpoint voor AJAX of API
    path('json/',             views.klanten_json),

    # Dossier‑routes
    path('dossiers/',                                 views.dossier_list),
    path('dossiers/nieuw/',                           views.dossier_create),
    path('dossiers/<int:klantnummer>/',               views.dossier_detail),
    path('dossiers/<int:klantnummer>/bewerken/',      views.dossier_edit),
    path('dossiers/<int:klantnummer>/werkbon/nieuw/', views.open_werkbon_form),
    path('dossiers/<int:klantnummer>/overleden/',     views.mark_overleden),
    path('dossiers/<int:klantnummer>/notities/add/',  views.add_notitie),

    # (optioneel) alias voor dossier_detail
    path('dossier/<int:klantnummer>/', views.dossier_detail),
]

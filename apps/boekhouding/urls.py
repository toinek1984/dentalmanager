...
urlpatterns = [
    path('crediteuren/', include('apps.boekhouding.crediteuren.urls')),
    path('debiteuren/', include('apps.boekhouding.debiteuren.urls')),
    path('facturatie/', include('apps.boekhouding.facturatie.urls')),
    path('grootboekrekeningen/', include('apps.boekhouding.grootboekrekeningen.urls')),
